...
class FirebaseManager:
    ...
    def update_with_details(self, person_detected, num_persons=0, confidence=0.0, fps=None):
        """Update Firebase with detailed detection info, including FPS."""
        if not self.connected:
            return
    ...
    try:
        while True:
            ...
            if current_time - last_firebase_update >= CONFIG['firebase_update_interval']:
                firebase.update_with_details(person_detected, person_count, max_conf, fps)
